...
## Problem setup
Assume an independent data sequence ${x_t, t ∈ N}$, where each $x_t = (x_{t1}, . . . , x_{tp})^⊤$ has entries with bounded fourth moments and correlation matrix R.
